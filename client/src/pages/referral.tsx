...
export default function Referral() {
  ...
  const payoutTiers = [
    { wager: "> $5,000", payout: "$25", min: 5000, max: 25000 },
    { wager: "> $25,000", payout: "$100", min: 25000, max: 50000 },
    { wager: "> $50,000", payout: "$250", min: 50000, max: 100000 },
    { wager: "> $100,000", payout: "$500", min: 100000, max: 250000 },
    { wager: "> $250,000", payout: "$1,000", min: 250000, max: 500000 },
    { wager: "> $500,000", payout: "$1,500", min: 500000, max: 1000000 },
    { wager: "> $1,000,000", payout: "$2,500", min: 1000000, max: Infinity },
  ];
